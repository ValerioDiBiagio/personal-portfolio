        ...
        <footer className=" bg-black relative z-10">
            <div className="container mx-auto flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 px-4">
                ...
                <div className="flex space-x-4 text-gray-300">
                    <a href="https://github.com/ValerioDiBiagio" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 neon-hover">
                        <FaGithub className="w-6 h-6" />
                    </a>
                    <a href="https://www.linkedin.com/in/valerio-di-biagio-429769387" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 neon-hover">
